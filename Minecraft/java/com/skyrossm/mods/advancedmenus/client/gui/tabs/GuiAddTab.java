...
public class GuiAddTab extends GuiScreen
{
    ...
    public GuiAddTab(GuiScreen parent)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 18, I18n.format("Add Tab", new Object[0])));
        ...
        if (button.enabled)
        {
            ...
            else if (button.id == 0)
            {
            	if(AdvancedMenus.getTabByName(this.tabName.getText()) != null){
            		...
            		AdvancedMenus.addTab(new ServerTab(this.tabName.getText()));
            		mc.displayGuiScreen(this.parentScreen);
            	}
            }
        }
    ...
    /**
     * Called when the mouse is clicke	d. Args : mouseX, mouseY, clickedButton
     */
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("Add Tab", new Object[0]), this.width / 2, 17, 16777215);
        if(exists){
